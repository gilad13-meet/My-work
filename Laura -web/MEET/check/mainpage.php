...
<div class="header">
<a class="a"><font color="#C8C8C8" style="font-family:La Bamba LET;"> Welcome!</font></a>
</div>
...
if($w['username']==$_SESSION['user']){
echo '<a href="delete.php?chatname=' . $w['chatname'] . '"><button class="button" style="background-color:white;border-radius:15px;margin-top:10px;" name="chatnameno" type="submit" value="' . $w['chatname'] . '">' . 'delete chat' . '</button>';}
if ($g!=0){
$l=$l/$g;
$l=round($l);
echo '<div class="du">';
